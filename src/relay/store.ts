...
/** Cache compiled header regexes to prevent allocating 6,000+ RegExp objects per store load. */
...
/** Module-level regex constants for deposit header parsing. */
