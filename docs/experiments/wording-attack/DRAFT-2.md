# Proposed normative sentences — digest domain, second draft

Draft. Not part of the specification.

The first draft legislated about objects it never defined; nine of fifteen findings
against it reduced to undefined terms or to one word used in two senses. Definitions
therefore come first, and every rule below is stated in them.
